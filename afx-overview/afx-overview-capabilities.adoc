...
FlexGroup ボリュームが AFX アーキテクチャからどのようなメリットを得られるかについては、link:afx-overview-architecture.html#flexgroup-volume-management-improvements["FlexGroup ボリューム管理の機能拡張"]を参照してください。
