...
link:https://www.netapp.com/pdf.html?item=/media/83591-tr-4963.pdf["TR-4963: セキュリティ強化ガイド: NetApp Backup and Recovery"^]組織が情報システムの機密性、整合性、可用性に関する規定のセキュリティ目標を達成できるように、 NetApp Cloud Backup for Applications を構成する方法を学習します。
